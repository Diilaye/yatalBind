...
const String BASE_URL = "https://yaatalmbinde.sn/api/v1/";
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        postResponse(url: 'sendContact', body: {
                    ...
                    child: Text(
                      'Envoyer',
                      style:
                          TextStyle(fontFamily: 'Poppins', color: yWhiteColor),
                    ),
...
Future getResponse({
  ...
  return http.get(urlFinal, headers: {
    ...
    return {"body": "success", "status": value.statusCode};
  });
}
...
Future postResponse(
  ...
  return http.post(urlFinal, body: json.encode(body), headers: {
    ...
    return {"body": "echec scolaire", "status": value.statusCode};
  });
}
