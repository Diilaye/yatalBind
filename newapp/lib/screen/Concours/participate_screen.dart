    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              SizedBox(width: 180, child: Image.asset(ySplashImage)),
              Text(
                "Vous pouvez déposer votre candidature ici / أرسل طلبك هنا",
                style: TextStyle(
                  fontSize: 16,
              ...
              _buildTextField(_firstNameController, 'Prénom / الاسم الأول',
                  Icons.account_circle),
              SizedBox(height: 15),
              _buildTextField(_lastNameController, 'Nom / الاسم الثاني',
                  Icons.account_circle),
              SizedBox(height: 15),
              _buildTextField(
                  _phoneController,
              ...
              GestureDetector(
                ...
                child: AbsorbPointer(
                  child: _buildTextField(_birthDateController,
                      'Date de Naissance', Icons.edit_calendar_outlined),
                ),
              ),
              SizedBox(height: 15),
              _buildTextField(_addressController, 'Adresse Exacte / العنوان',
                  Icons.maps_home_work),
              SizedBox(height: 15),
              _buildTextField(
                  _schoolController, 'École / المدرسة', Icons.school_rounded),
              SizedBox(height: 15),
              _buildTextField(_professorController, 'Professeur / المعلم',
                  Icons.school_sharp),
              SizedBox(height: 20),
              _extraitFile != null
                  ? ClipRRect(
