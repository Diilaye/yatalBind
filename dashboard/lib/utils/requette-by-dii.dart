...
const String BASE_URL = "http://localhost:4600/api/v1";
// const String BASE_URL = "https://api.yaatalmbinde.sn/api/v1";

// const String BASE_URL_ASSET = "http://localhost:4600";
const String BASE_URL_ASSET = "https://api.yaatalmbinde.sn";
